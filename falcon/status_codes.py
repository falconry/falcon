...
HTTP_413 = HTTP_REQUEST_CONTENT_TOO_LARGE = '413 Content Too Large'
...
HTTP_422 = HTTP_UNPROCESSABLE_CONTENT = '422 Unprocessable Content'
...
__all__ = (
    ...
    'HTTP_REQUEST_CONTENT_TOO_LARGE',
