...
def create_scope_ws(
    ...
    # NOTE(kgriffs): Build from the HTTP scope to reuse all its construction
    #   logic, then copy the shared fields into a proper WebSocketScope. We
    #   cannot mutate the HTTPScope in-place because TypedDicts do not allow
    #   deleting required keys (e.g. 'method').
