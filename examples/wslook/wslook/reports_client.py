...
# Since it's an example using the `websockets` library and it isn't using anything specific
# to Falcon, there are no tests. Coverage is skipped for this module.
