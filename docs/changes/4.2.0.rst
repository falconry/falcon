...
This release primarily contains typing enhancements and performance
optimizations. It is also the first time we ship pre-compiled wheels for the
:ref:`free-threaded <faq_free_threading>` CPython 3.14 build.
:ref:`Let us know` if you are tinkering with scaling Falcon apps via free-threading!

The typing improvements revolve around making the WSGI and ASGI App types
